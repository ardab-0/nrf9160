...
measurement_filename = "../raw_measurements/erlangen_train.json"  # file produced by the capture_measurement.py
coordinate_filename = "../raw_measurements/Erlangen-train.kml"  # file recorded by the gps tracker application
dataset_filename = "../combined_measurements/Erlangen-train-timeidx-minadjusted.csv"  # output file
...
def main():
    ...
    for i, measurement_batch in enumerate(measurements):
        ...
        measurement_data_np[i, :4] = np.array( [time_idx,
